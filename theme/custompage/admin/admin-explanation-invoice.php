...
$receipt_id = $spiritSchedule->getScheduleReceipt($receipt_year,$receipt_month,$receipt_user_id);
...
//お振込み期限
$receipt_disp_array["お振込み期限"] = $receipt_year . "年" . $receipt_month . "月" . $invoice_pay_day . "日";
...
//振込先
$receipt_disp_array["振込先"] = nl2br(get_field('acf_teacher_profile_transfer_destination', 'user_' . $receipt_user_id));
...
<div class="receipt-print-area">
  <div class="receipt-title">請求書</div>
  <div class="receipt-header">
    <div class="receipt-header-left">
      <?php echo $receipt_disp_array["会社宛先"]; ?>　御中
    </div>
    <div class="receipt-header-right">
      請求日：<?php echo $receipt_disp_array["請求日"]; ?><br>
      <?php echo $receipt_disp_array["担当者"]; ?>
    </div>
  </div>
  <div class="receipt-section"><?php echo $receipt_disp_array["請求分"]?>実施分の電話対応として</div>
  <div class="receipt-section">下記の通り、ご請求申し上げます。</div>
  ...
  <div class="invoice-info-area">
    <div class="invoice-info-block">
      <div class="invoice-info-label">お振込み期限</div>
      <div class="invoice-info-box"><?php echo $receipt_disp_array["お振込み期限"]; ?></div>
    </div>
    <div class="invoice-info-block">
      <div class="invoice-info-label">◆振込先</div>
      <div class="invoice-info-box"><?php echo $receipt_disp_array["振込先"]; ?></div>
    </div>
  </div>
