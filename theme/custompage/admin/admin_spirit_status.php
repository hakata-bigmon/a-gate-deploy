...
<?php 
    ...
    if(isset($_POST["input_add_name"]))
    {
        ...
        if($spirit_sheet_data->checkSpiritAdminStatus( 0 , $_POST["input_add_name"] ,'cpt_spirit_status'))
        {
            $new_err = "同じ名前のものは登録できません";
        }
        else if($_POST["input_add_name"] != "")
        {
            $spirit_sheet_data->newSpiritAdminStatus( $_POST["input_add_name"]   , $_POST["input_edit_text_color"] , $_POST["input_edit_back_color"] ,'cpt_spirit_status');
        }
        else{
    ...
    if(isset($_POST["input_edit_name"]))
    {
        ...
        if($spirit_sheet_data->checkSpiritAdminStatus( $_POST["edit_no"] , $_POST["input_edit_name"] ,'cpt_spirit_status'))
        {
            $edit_err = "同じ名前のものは登録できません";
        }
        else if($_POST["input_edit_name"] != "")
        {
            $spirit_sheet_data->saveSpiritAdminStatusTitle( $_POST["edit_no"] , $_POST["input_edit_name"]  , $_POST["input_edit_text_color"] , $_POST["input_edit_back_color"] );
        }
        else{
...
<div class="admin-exorcism-area">
    ...
    <div class="admin-exorcism-button-area">
        ...
        <div class="admin-exorcism-menu-title-box"><div class="admin-exorcism-menu-title">管理者　浄霊・鑑定ステータス設定</div></div>
        ...
        <div class="admin-spirit-edit-area">
            ...
            <div class="admin-spirit-edit-box">
                ...
                <form action="<?php echo  getURLSetSlag( "admin_spirit_status" );?>" name="add_item" method="post" id="add_item">
            ...
            <div class="admin-spirit-edit-box">
                ...
                <form action="<?php echo  getURLSetSlag( "admin_spirit_status" );?>" name="add_item" method="post" id="edit_item">
                    <div class="admin-spirit-edit-flex">
        ...
        <div class="admin-spirit-edit-list-area">
                ...
                <form id="orderForm" action="<?php echo  getURLSetSlag( "admin_spirit_status" );?>" method="post" >
                ...
                <table id="adminSpiritEditTableID" class="adminSpiritEditTable" >
                    ...
                    ?>
                            ...
                            <tr data-id="<?php echo $value["ID"];?>" >
                                ...
                                <td style="width: 70px;">
                                     <form action="<?php echo  getURLSetSlag( "admin_spirit_status" );?>" method="post" style="display:inline;">
                                ...
                                <td style="width: 70px;">
                                     <form action="<?php echo  getURLSetSlag( "admin_spirit_status" );?>" id="delete_item_<?php echo  $value["ID"]; ?>" method="post" style="display:inline;">
