...
<?php 
    ...
    if(isset($_POST["input_add_name"]))
    {
        ...
        if($spirit_sheet_data->checkGeneralPurposeData( 0 , $_POST["input_add_name"]  , "cpt_sales_category"))
        {
            $new_err = "同じ名前のものは登録できません";
        }
        else if($_POST["input_add_name"] != "")
        {
            $spirit_sheet_data->newGeneralPurposeData( $_POST["input_add_name"] , "cpt_sales_category");
        }
        else{
    ...
    if(isset($_POST["input_edit_name"]))
    {
        ...
        if($spirit_sheet_data->checkGeneralPurposeData( $_POST["edit_no"] , $_POST["input_edit_name"]  , "cpt_sales_category"))
        {
    ...
    if(isset($_POST["delete_no"]))
    {
     ...
     $spiritStatusArray = $spirit_sheet_data->getGeneralPurposeData("cpt_sales_category");
?>
...
<div class="admin-exorcism-area">
    ...
    <div class="admin-exorcism-button-area">
        ...
        <div class="admin-exorcism-menu-title-box"><div class="admin-exorcism-menu-title">物販販売カテゴリー設定</div></div>
        ...
        <div class="admin-spirit-edit-area">
            ...
            <div class="admin-spirit-edit-box">
                ...
                <form action="<?php echo  getURLSetSlag( "admin-sales-category" );?>" name="add_item" method="post" id="add_item">
                    ...
                    <div class="admin-spirit-edit-flex">
                        ...
                        <div class="admin-spirit-edit-inputbutton-area">
                            <input class="admin-spirit-edit-button" type="button" style="margin-top: 0px;" value="項目追加" onclick="saveItemAddData()"/>
                        </div>
            ...
            <div class="admin-spirit-edit-box">
                ...
                <form action="<?php echo  getURLSetSlag( "admin-sales-category" );?>" name="add_item" method="post" id="edit_item">
                    <div class="admin-spirit-edit-flex">
        ...
        <?php if($spiritStatusArray != ""){ ?>
            ...
            <div class="admin-spirit-edit-list-area">
                    ...
                    <form id="orderForm" action="<?php echo  getURLSetSlag( "admin-sales-category" );?>" method="post" >
                    ...
                    <table id="adminSpiritEditTableID" class="adminSpiritEditTable" >
                        ...
                        ?>
                                ...
                                <tr data-id="<?php echo $value["ID"];?>" >
                                    ...
                                    <td style="width: 70px;">
                                         <form action="<?php echo  getURLSetSlag( "admin-sales-category" );?>" method="post" style="display:inline;">
                                    ...
                                    <td style="width: 70px;">
                                         <form action="<?php echo  getURLSetSlag( "admin-sales-category" );?>" id="delete_item_<?php echo  $value["ID"]; ?>" method="post" style="display:inline;">
                     ...
                     <div class="admin-spirit-return-button-area">
                         <button type=“button” class="admin-exorcism-menu-status-button" onclick="location.href='<?php echo getURLSetSlag("admin-exorcism-price-setting"); ?>'">施術価格・最大個数・最小個数設定へ</button>
                     </div>

                     <div class="admin-spirit-return-button-area">
                         <button type=“button” class="admin-exorcism-menu-status-button" onclick="location.href='<?php echo getURLSetSlag("admin-sales-list"); ?>'">販売ページ編集へ</button>
                     </div>

                     <div class="admin-spirit-return-button-area">
                         <button type=“button” class="admin-exorcism-menu-status-button" onclick="location.href='<?php echo getURLSetSlag("admin-exorcism-list"); ?>'" style="background-color: gainsboro;">施術設定へ</button>
                     </div>
