...
<div class="">
    ...
    <div class="admin-exorcism-button-area">
        ...
        <div class="admin-exorcism-menu-title-box"><div class="admin-exorcism-menu-title">スケジュールページリスト</div></div>

    <?php 
    
         foreach ($spiritTypeArray as $key => $value) {

            if($key != SpiritTypeClass::SPIRIT_TYPE_NAME_DAY && $key != SpiritTypeClass::SPIRIT_TYPE_NAME_SODAN)
            {
                continue;
            }
         ...
         <div class="admin-exorcism-button-type-area">
            ...
            ?>
                ...
                <div class="admin-exorcism-menu-button-box">
                    <button type=“button” class="admin-exorcism-menu-button" onclick="location.href='<?php echo getURLSetSlag("admin-schedule-page-edit"); ?>?type_id=<?php echo $value_num["ID"]; ?>'"><?php echo $value_num["title"]; ?></button>
                </div>
            <?php
                }
            ?>
