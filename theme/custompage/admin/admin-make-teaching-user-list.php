    ...
    <div class="admin-spirit-sheets-button-flex" style="display: flex; justify-content: flex-end; margin: 20px 0;">
        <div class="admin-preview-button-flex">
            <div class="admin-preview-button-flex-box">
                <button class="admin-preview-button" type="button" onclick="location.href='<?php echo getURLSetSlag('admin-make-teaching-user'); ?>'">新規先生作成</button>
            </div>
        </div>
    </div>
            ...
            <tbody>
                <?php foreach ($users as $user) { ?>
                    <tr>
                        ...
                        <td>
                            <button class="admin-preview-button" type="button" onclick="location.href='<?php echo getURLSetSlag('admin-make-teaching-user'); ?>?user_id=<?php echo $user->ID; ?>'" style="width: 100px; background-color: #D6E9F5;">編集</button>
                        </td>
