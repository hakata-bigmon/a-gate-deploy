...
<div style="margin-left: 30px;margin-right: 30px;">
    <?php 
        // 全浄霊内容
        if($user_split_data != NULL){
            $all_split_table = make_all_split_table('all_split_table',$user_split_data,$spirit_sheet_data,$check_user_id);
        }else{
    ...
    ?>
        ...
        <?php 
            $target_split_table = make_all_split_table('target_split_table',$applicant_split_data,$spirit_sheet_data,$check_user_id);
    ...
    ?>
        ...
        <?php 
            $intro_split_table = make_all_split_table('intro_split_table',$applicant_split_data,$spirit_sheet_data,$check_user_id);
        ...
        <script>
            ...
            $(document).ready( function () {
                ...
                $('#intro_split_table').DataTable({
                    ...
                    searching: false, // 検索ウィンドウを非表示
                    paging: false,     // ページングを無効にして全件表示
