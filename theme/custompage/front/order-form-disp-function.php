...
?>
        ...
        <div class="orderform-question-box">
            ...
            <div class="orderform-question-input-area">
                ...
                <div class="orderform-question-title">
                    ...
                    <div class="orderform-question-title-right">登録時ＩＤ</div>
                </div>

                <div class="orderform-input-textbox">
                    <input type="number" name="input_registered_id" id="input_registered_id"  style="width: 150px;" value="<?php if( isset( $_POST["input_registered_id"] )){ echo $_POST[ "input_registered_id"];  } ?>" placeholder="15桁の数値を入力してください" required >
                </div>
        ...
        <div class="orderform-question-box">
            ...
            <div class="orderform-input-mail">
                <!-- <input type="mail" name="input_user_email" id="input_user_email" value="<?php if( isset( $_POST["input_user_email"] )){ echo $_POST[ "input_user_email"];  } ?>" placeholder="" required/>　 -->
            ...
            <div class="orderform-input-calendar-message">上記のIDに登録されたメールアドレスを入力してください</div>
...
<?php
	...
	function getPersonalDataInputData($id,$post_data,$registered_id = "")
	{
        ...
        else if($id == 489)//紹介者コード
		{
            ...
            if($registered_id == ""){
                ...
                // 該当者がいない場合赤文字で表示させる　241217追加
                $all_unique_id = GetUniqueIDs();

                $found = false;
                // 配列をループで回す
                foreach ($all_unique_id as $value) {
                    if (strpos($value, $cord) !== false) {
                        $found = true;
                ...
                if(!$found) return '<div class="" style="color:red">該当のユーザーがいません</div>';
        ...
        else if($id == 507)//性別
		{
            if($registered_id == ""){
                ...
                if( isset( $post_data["input_sex"] ))
                {
                    ...
                    else if($post_data["input_sex"] == "U"){ return "不明";}
                }
            }else{
        ...
        else if($id == 508)//対象者の性別
		{
            ...
            if( isset( $post_data["input_target_sex"] ))
            {
                ...
                else if($post_data["input_target_sex"] == "U"){ return "不明";}
            }
        }
    ...
    **                質問内容の回答の関数
    *****************************************************************************************************/
	function getQuestionInputData($id,$post_data,$question_type , $add , $imgUrl )
	{
...
?>
                    ...
                    <div class="orderform-question-input-area">
                        <div class="orderform-input-img"><?php if(isset($imgUrl[$id][$i])){?><img src="<?php echo $imgUrl[$id][$i]["URL"];?>"><?php } ?>  
                    </div>
            ...
            <?php if($is_check == false){?>
                ...
                <?php 
                    ...
                    if($registered_id != "")
                    {
                        ...
                        $input_user_email = CheckFamilyMail($user->user_email);
                    }
                    else{
                ...
                <script>
                    ...
                    // 入力された値を取得
                        ...
                        // アルファベット（大文字・小文字）と記号（英数字+@._-）のみ許可
                        const validPattern = /^[a-zA-Z0-9@._-]+$/;

                        if (!validPattern.test(value) && value != "") {
                            // 無効な文字が検出された場合
                            // alert('アルファベットまたは記号以外の文字が入力されました。');
...
?>
            ...
            <?php if($is_check == false){?>
                ...
                <div class="orderform-input-textbox">
                    都道府県・市区町村
                    <input type="text" name="input_parents_address1" id="input_parents_address" value="<?php  echo $input_address1; ?>" placeholder="現住所と同じの場合は同上と記入ください"  <?php if($data_array[$id][1] != ""){?>required <?php } ?> style=""/>　
                </div>
                ...
                <?php 
                    ...
                    if($registered_id != "")
                    {
                        ...
                        if($year != "")
                        {
                            ...
                            $input_user_born =  $year . "-" .$month . "-" .$day;
                        }

                        echo $input_user_born;
                    }
                    else{
...
?>
            ...
            <?php if($is_check == false){?>
                ...
                <div class="orderform-input-calendar">
                      ...
                      <input type="date" name="input_user_report" id="input_user_report" value="<?php echo $input_user_born?>" placeholder="" style="width: 120px;border: 1px solid black;"  <?php if($data_array[$id][1] != ""){?>required <?php } ?>/>
                </div>
             ...
             <?php if($is_check == false){?>
                ...
                <?php 
                    ...
                    if($registered_id != "")
                    {
                        ...
                        $t_id = get_user_meta($registered_id,'input_introduction_id',true);
                        $input_introduction_id = get_user_meta($t_id,'user_unique_id',true);
                ...
                <div class="orderform-input-textbox">
                    <input type="number" name="input_introduction_id" id="input_introduction_id" value="<?php  echo $input_introduction_id; ?>" style="width:250px" placeholder="15桁の数値を入力してください" ?>
                    <div id="error-message" style="color:red;display:none">有効な桁数で入力してください</div>
                </div>

                <script>
                    document.getElementById('input_introduction_id').addEventListener('input', function() {
                        const inputField = this;
                        const errorMessage = document.getElementById('error-message');
                        const value = inputField.value;

                        // 15桁の数値であるかチェック
                        if (/^\d{15}$/.test(value) || value === "") {
                            errorMessage.style.display = "none"; // 問題なし
                        } else {
                ...
                <div class="orderform-input-calendar-message">紹介者のIDがわかる場合はご入力ください。</div>
             ...
             <?php if($is_check == false){?>
                ...
                <div class="orderform-input-select">
                    ...
                    <select  name="input_sex" id="input_sex" <?php if($data_array[$id][1] != ""){?>required <?php } ?>>
                        ...
                        <option value="U" <?php  if( $input_sex == "U" ){ echo "selected"; } ?>>不明</option>
...
<?php
		...
		{
            $target_sex = "";
            if(isset($_POST["input_target_sex"])) $target_sex = $_POST["input_target_sex"];
?>
             ...
             <?php if($is_check == false){?>
                ...
                <div class="orderform-input-select">
                    ...
                    <select  name="input_target_sex" id="input_target_sex" <?php if($data_array[$id][1] != ""){?>class="required" <?php } ?>>
                        <option value=""></option>
                        <option value="M" <?php if($target_sex == "M") echo "selected"; ?>>男性</option>
                        <option value="W" <?php if($target_sex == "W") echo "selected"; ?>>女性</option>
                        <option value="U" <?php if ($target_sex == "U") echo "selected"; ?>>不明</option>
